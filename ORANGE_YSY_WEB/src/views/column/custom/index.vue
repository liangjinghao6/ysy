<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      ...
      <el-input style="width: 200px;" class="filter-item" v-model="hdQuery.q" placeholder="请输入名称" @keyup.enter.native="doQuery">
      </el-input>
    ...
    methods: {
      ...
      doRemove(id) {
        this.$confirm('确定删除本数据?', '提示', {}).then(() => {
          ...
          this.$http.get('/edi/custom/column/delete?id=' + id).then(response => {
      ...
      doQuery() {
        ...
        this.$http.post('/edi/custom/column/find', this.hdQuery).then(response => {
