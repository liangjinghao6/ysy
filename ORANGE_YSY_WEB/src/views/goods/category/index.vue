<template>
  <div class="app-container calendar-list-container">
	...
	<el-col :span="12">
          <el-table-column width="150px" align="center" label="类别编号" prop="categoryNo" >
	...
	<el-col :span="12">
          <el-table-column width="150px" align="center" label="类别名称" prop="categoryName" >
		<template slot-scope="scope">
	...
	<el-col :span="12">
          <el-table-column width="150px" align="center" label="类别描述" prop="description" >
		<template slot-scope="scope">
	...
	<el-col :span="12">
      ...
      <el-table-column width="150px" align="center" label="操作">
        <template slot-scope="scope">
          <el-button size="small" type="success" @click="doEdit(scope.row.categoryId, 'update')">编辑
          </el-button>
          <el-button size="small" type="danger" @click="doRemove(scope.row.categoryId)">删除
          </el-button>
        </template>
      </el-table-column>
    ...
    <goodscategoryform ref="goodscategoryform" @save-ok="doQuery"></goodscategoryform>
...
<script>
  ...
  export default {
    ...
    methods: {
      doEdit(id, method) {
        this.$refs['goodscategoryform'].show(id, method)
      },
      doRemove(id) {
        this.$confirm('确定删除本数据?', '提示', {}).then(() => {
          this.listLoading = true
          this.$http.get('/iweb/goodscategory/delete?id=' + id).then(response => {
      ...
      doQuery() {
        this.listLoading = true
        this.$http.get(`/iweb/goodscategory/find?q=${this.queryInfo.query.q}&pageNum=${this.queryInfo.pageNum}&pageSize=${this.queryInfo.pageSize}`).then(response => {
