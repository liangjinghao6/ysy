  ...
  export default {
    ...
    methods: {
      show(id, method) {
        ...
        this.$http.get('/edi/edi/source/detail/' + id).then(response => {
      ...
      add() {
        this.loading = true
        this.$http.post('/edi/edi/source/add', this.hdform).then(response => {
          this.loading = false
      ...
      update() {
        this.loading = true
        this.$http.post('/edi/edi/source/update', this.hdform).then(response => {
          this.loading = false
          const data = response.data
          this.$message({
            type: data.status ? 'success' : 'error',
