<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table :data="hdResult.data" v-loading="listLoading" border fit highlight-current-row
      ...
      <el-table-column width="" align="center" label="描述" prop="description" sortable>
        <template slot-scope="scope">
    ...
    methods: {
      ...
      doRemove(id) {
        this.$confirm('确定删除本数据?', '提示', {}).then(() => {
          ...
          this.$http.get('/edi/edi/source/delete?id=' + id).then(response => {
      ...
      doQuery() {
        this.listLoading = true
        this.$http.post('/edi/edi/source/find', this.hdQuery).then(response => {
