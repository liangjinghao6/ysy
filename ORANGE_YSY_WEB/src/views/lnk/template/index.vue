<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table :data="hdResult.data" v-loading="listLoading" border fit highlight-current-row
      ...
      <el-table-column width="120px" align="center" label="所属公司" prop="type" sortable>
        <template slot-scope="scope">
    ...
    methods: {
      ...
      doRemove(id) {
        this.$confirm('确定删除本数据?', '提示', {}).then(() => {
          ...
          this.$http.get('/edi/lnk/tmp/delete?id=' + id).then(response => {
      ...
      doQuery() {
        this.listLoading = true
        this.$http.post('/edi/lnk/tmp/find', this.hdQuery).then(response => {
