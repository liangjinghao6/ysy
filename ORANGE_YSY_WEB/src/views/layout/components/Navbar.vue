...
-->
      ...
      <!--<el-dropdown trigger="click" class='international' @command="handleSetLanguage">-->
        ...
        <!--&lt;!&ndash;<el-dropdown-menu slot="dropdown">&ndash;&gt;-->
          <!--&lt;!&ndash;<el-dropdown-item command="zh" :disabled="language==='zh'">中文</el-dropdown-item>&ndash;&gt;-->
          <!--&lt;!&ndash;<el-dropdown-item command="en" :disabled="language==='en'">English</el-dropdown-item>&ndash;&gt;-->
