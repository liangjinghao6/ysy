...
public class RegexUtil {
	...
	public static String removeString(String dealStr, String regexStr){
		return dealStr.replaceAll(regexStr, "");
	}
	...
	public static void main(String[] args) {
		...
		String dealStr = "ab1234asdab1234av";
		String regexStr = "a(.*?)a";
		System.out.println(RegexUtil.getString(dealStr, regexStr, 1));
		System.out.println(RegexUtil.removeString(dealStr, "a.*?a"));
		...
		System.out.println("****************************");
//		str = RegexUtil.removeString(str, "(<script).*?(script>)");
//		str = RegexUtil.removeString(str, "(<script).*?(script>)");
//		str = RegexUtil.removeString(str, "(<script).*?(script>)");
		System.out.println(RegexUtil.removeString(str, "<[\\s]*?script[^>]*?>[\\s\\S]*?<[\\s]*?\\/[\\s]*?script[\\s]*?>"));
		System.out.println("****************************");
	}
