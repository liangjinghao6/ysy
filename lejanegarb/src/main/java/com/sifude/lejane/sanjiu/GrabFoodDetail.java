...
/**
 * @author 梁景皓
 * @version 创建时间：2016年4月1日 上午11:12:30
 * 抓取一个健康饮食的文章
 */
public class GrabFoodDetail extends CrawlListPageBase{
...
//				+ "_39wt_session_refer_cookie=http%253A%252F%252Fcare.39.net%252Fys%252Fjkjj%252Findex.html; _gat=1");
	...
	public GrabFoodDetail(String pageUrl) {
	...
	public static void main(String[] args) {
		...
		GrabFoodDetail grab = new GrabFoodDetail("http://food.39.net/a/201189/1772295.html");
