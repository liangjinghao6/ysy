...
public class SysFileController {
	...
	public ResultBean addSysFile(@RequestBody YsySysFile sysfile) {
		try {
			...
			return ResultUtil.returnResult(sysfile, "增加{替换一下加注解}成功");
		} catch (Exception e) {
	...
	public ResultBean findSysFile(@RequestParam(value = "page", defaultValue = "1") Integer pageNum,
		...
		try {
			...
			return ResultUtil.returnResult(sysfiles, "查询{替换一下加注解}成功");
		} catch (Exception e) {
	...
	public ResultBean findSysFile(@PathVariable String id) {
		...
		try {
			...
			return ResultUtil.returnResult(sysfiles, "查询{替换一下加注解}详情成功");
		} catch (Exception e) {
